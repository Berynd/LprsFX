...
public class DossierInscriptionRepository extends BaseRepository {
    ...
    public int ajouterDossierInscription(DossierInscription d) {
        ...
        try (PreparedStatement stmt = getCnx().prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            System.err.println("Erreur ajout dossier : " + e.getMessage());
        }
        return -1;
    }
    ...
    public List<DossierInscription> getDossiersParEtudiant(int idEtudiant) {
        ...
        try (PreparedStatement stmt = getCnx().prepareStatement(sql)) {
            ...
            System.err.println("Erreur récupération dossiers étudiant : " + e.getMessage());
        }
        return list;
    }
    ...
    public boolean changerStatut(int idDossier, String statut) {
        ...
        try (PreparedStatement stmt = getCnx().prepareStatement(sql)) {
            ...
            System.err.println("Erreur changement statut dossier : " + e.getMessage());
            return false;
        }
    }
    ...
    public boolean modifierDossierInscription(DossierInscription d) {
        ...
        try (PreparedStatement stmt = getCnx().prepareStatement(sql)) {
            ...
            System.err.println("Erreur modification dossier : " + e.getMessage());
            return false;
        }
    }
    ...
    public int countByStatut(String statut) {
        ...
        try (PreparedStatement ps = getCnx().prepareStatement(sql)) {
            ...
            System.err.println("Erreur count dossiers : " + e.getMessage());
        }
        return 0;
    }
